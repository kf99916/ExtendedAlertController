#
#  Be sure to run `pod spec lint ExtendedAlertController.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ExtendedAlertController"
  spec.version      = "0.0.1"
  spec.summary      = "ExtendedAlertController empowers your UIAlertController."
  ...
  spec.author             = { "Zheng-Xiang Ke" => "kf99916@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/kf99916/ExtendedAlertController.git", :tag => "#{spec.version}" }
